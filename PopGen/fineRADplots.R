...
library(here) ## The directory where the files are located
chunkfile<-"CCGOM_input_chunks.out" ## RADpainter output file
mcmcfile<-"CCGOM_input_chunks.mcmc.xml" ## finestructure mcmc file
treefile<-"CCGOM_input_chunks.mcmcTree.xml" ## finestructure tree file
...
analysisName <- "CCGOM";  maxIndv <- 1000; maxPop<-1000
